...
import { extractContributions, parseTranscriptJson } from "@/app/api/integrations/workflow/transcription";
...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ contributions: extractContributions(parsed) });
  } catch {
